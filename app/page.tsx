    ...
    <main>
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <textarea
          ...
          placeholder='e.g., "I am on vacation and it is raining all week!"'
          required
          maxLength={500}
        ...
        <div className="flex items-center justify-between text-xs opacity-70">
          ...
          <button
            ...
            className="rounded-xl border px-4 py-2 text-sm hover:bg-black/5 disabled:opacity-50 dark:hover:bg-white/10"
          >
      ...
      {data && (
        <section className="mt-8 space-y-4">
          <div className="rounded-2xl border p-4">
            ...
            <p className="leading-relaxed whitespace-pre-wrap">{data.guidance}</p>
          </div>
